...
int main(void)
{
    ...
    LOGP("  _____                        ");
    LOGP("/  ___|                       ");
    LOGP("\\ `--.  ___  _ __   __ _ _ __ ");
    LOGP(" `--. \\/ _ \\| '_ \\ / _` | '__|");
    LOGP("/\\__/ / (_) | | | | (_| | |   ");
    LOGP("\\____/ \\___/|_| |_|\\__,_|_|   ");
    LOGP("STM32 Sonar DSP System Initializing...");
    ...
    LOGP("SyncSignalApp OK");
    LOGP("System Ready - Pipeline Running (Freq: %lu Hz)", SystemCoreClock);
